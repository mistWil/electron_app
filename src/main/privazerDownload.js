...
async function downloadPrivazer() {
  try {
    ...
    const response = await axios.get('http://localhost:3000/privazer/securityTools');
    ...
    const savePath = dialog.showSaveDialogSync({
      title: 'Save Privazer', // Titre de la boîte de dialogue
      defaultPath: path.join(getDefaultDownloadPath(), 'Privazer.exe') // Chemin par défaut pour enregistrer le fichier
    });
...
module.exports = downloadPrivazer;
