...
async function downloadProtonVpn() {
  try {
    ...
    const response = await axios.get('http://localhost:3000/protonVpn/securityTools');
    ...
    const savePath = dialog.showSaveDialogSync({
      title: 'Save Proton Vpn', // Titre de la boîte de dialogue
      defaultPath: path.join(getDefaultDownloadPath(), 'Proton.exe') // Chemin par défaut pour enregistrer le fichier
    });
...
module.exports = downloadProtonVpn;
